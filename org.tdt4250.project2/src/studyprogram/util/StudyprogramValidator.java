...
public class StudyprogramValidator extends EObjectValidator {
	...
	public boolean validateSemester(Semester semester, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateSemester_noDuplicateCourses(semester, diagnostics, context);
		return result;
	}

	/**
	 * Validates the noDuplicateCourses constraint of '<em>Semester</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	public boolean validateSemester_noDuplicateCourses(Semester semester, DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO implement the constraint
		// -> specify the condition that violates the constraint
		// -> verify the diagnostic details, including severity, code, and message
		// Ensure that you remove @generated or mark it @generated NOT
		if (! semesterSlotsUniqueCourses(semester)) {
			if (diagnostics != null) {
				diagnostics.add
					(createDiagnostic
						(Diagnostic.ERROR,
						 ...
						 new Object[] { "noDuplicateCourses", getObjectLabel(semester, context) },
						 new Object[] { semester },
						 context));
			}
			return false;
	...
	private boolean semesterSlotsUniqueCourses(Semester semester) {
		ArrayList<Course> selectedCourses = new ArrayList<Course>();
		for(Slot slot: semester.getSlots()) {
			if (selectedCourses.contains(slot.getSelectedCourse())) {
				return false;
			}
			else {
				selectedCourses.add(slot.getSelectedCourse());
			}
		}
		return true;
	}
	...
	public boolean validateSlot(Slot slot, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateSlot_selectedCourseInAvailableCourses(slot, diagnostics, context);
		return result;
	}

	/**
	 * Validates the selectedCourseInAvailableCourses constraint of '<em>Slot</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateSlot_selectedCourseInAvailableCourses(Slot slot, DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO implement the constraint
		// -> specify the condition that violates the constraint
		// -> verify the diagnostic details, including severity, code, and message
		// Ensure that you remove @generated or mark it @generated NOT
				...
				diagnostics.add
					(createDiagnostic
						(Diagnostic.ERROR,
						 ...
						 0,
						 "_UI_GenericConstraint_diagnostic",
						 new Object[] { "selectedCourseInAvailableCourses", getObjectLabel(slot, context) },
						 new Object[] { slot },
						 context));
			}
			return false;
