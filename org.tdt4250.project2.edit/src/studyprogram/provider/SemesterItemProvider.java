...
/**
 * This is the item provider adapter for a {@link studyprogram.Semester} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SemesterItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramPackage.Literals.SEMESTER__YEAR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyprogramPackage.Literals.SEMESTER__SLOTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Semester.class)) {
			...
			case StudyprogramPackage.SEMESTER__YEAR:
				...
				return;
			case StudyprogramPackage.SEMESTER__SLOTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyprogramPackage.Literals.SEMESTER__SLOTS,
				 StudyprogramFactory.eINSTANCE.createSlot()));
	}
