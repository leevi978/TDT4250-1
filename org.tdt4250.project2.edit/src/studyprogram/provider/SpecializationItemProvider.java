...
/**
 * This is the item provider adapter for a {@link studyprogram.Specialization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SpecializationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramPackage.Literals.SPECIALIZATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StudyprogramPackage.Literals.SPECIALIZATION__SPECIALIZATION_SEMESTERS);
			childrenFeatures.add(StudyprogramPackage.Literals.SPECIALIZATION__ADDITIONAL_SPECIALIZATIONS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StudyprogramPackage.Literals.SPECIALIZATION__SPECIALIZATION_SEMESTERS,
				 StudyprogramFactory.eINSTANCE.createSemester()));

		newChildDescriptors.add
			(createChildParameter
				(StudyprogramPackage.Literals.SPECIALIZATION__ADDITIONAL_SPECIALIZATIONS,
