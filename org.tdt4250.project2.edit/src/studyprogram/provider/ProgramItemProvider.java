...
/**
 * This is the item provider adapter for a {@link studyprogram.Program} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProgramItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addTotalBaseCreditsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StudyprogramPackage.Literals.PROGRAM__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Total Base Credits feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addTotalBaseCreditsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Program_totalBaseCredits_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Program_totalBaseCredits_feature", "_UI_Program_type"),
				 StudyprogramPackage.Literals.PROGRAM__TOTAL_BASE_CREDITS,
				 true,
				 false,
				 false,
